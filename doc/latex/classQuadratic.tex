...
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classQuadratic_aa5d5e8e58a9d0aaf332e6b8b879430b8}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}}\label{classQuadratic_ad074fa92b51e0590f6621b60ac01219a}


intersection operator 

\begin{DoxyVerb}  The intersection operator is used to find the height of intersection
...
\item[{const double}]{y}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}}\label{classQuadratic_ae1f3f6d71209aafe6bb1636a8c17489c}


lower-\/envelope operator 

\begin{DoxyVerb}  given the pixel location of the lower envelope, calculate the true
...
\item[{int}]{x}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}}\label{classQuadratic_a0fd7e9cc0ce3028a7db656ec0cb8f84f}
...
\subsubsection[{a}]{\setlength{\rightskip}{0pt plus 5cm}double const Quadratic\-::a}}\label{classQuadratic_a3784ebac36b04b9195d44d6d5bc8933a}
\hypertarget{classQuadratic_a1df1154ac27afe4533b5b695831ed23a}{\index{Quadratic@{Quadratic}!b@{b}}
\index{b@{b}!Quadratic@{Quadratic}}
\subsubsection[{b}]{\setlength{\rightskip}{0pt plus 5cm}double const Quadratic\-::b}}\label{classQuadratic_a1df1154ac27afe4533b5b695831ed23a}
